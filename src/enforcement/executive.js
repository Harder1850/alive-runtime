...
exports.getMissionThresholds = getMissionThresholds;
const fs_1 = require("fs");
const path_1 = require("path");
const RUNTIME_ROOT = (0, path_1.join)(__dirname, '..', '..');
function loadJSON(filename) {
    const path = (0, path_1.join)(RUNTIME_ROOT, filename);
...
const CONSTITUTION = loadJSON('CONSTITUTION.json');
 ...
 */
function authorize(signal, triage) {
    const now = Date.now();
